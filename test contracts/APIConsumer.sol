...
contract APIConsumer is ChainlinkClient {
    ...
    bytes32 public  random_number;
    address public oracle;
    bytes32 public jobId;
    uint256 public fee;
    
    constructor(address _oracle, string memory _jobID) public {
    ...
    function randNum() public returns (bytes32 requestId) 
    {
    ...
    function randNumNoParams() public returns (bytes32 requestId) 
    {
        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);
    ...
    function fulfill(bytes32 _requestId, bytes32 _num) public recordChainlinkFulfillment(_requestId)
    {
        random_number = _num;
    }
